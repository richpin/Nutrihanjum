import { CloudFunction, Change, https } from 'firebase-functions';
...
export declare function wrap<T>(cloudFunction: CloudFunction<T>): WrappedScheduledFunction | WrappedFunction;
